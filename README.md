...
This repository is prepared for GitHub Pages. After publishing, use the Pages URL that serves `docs/index.html`.
...
For GitHub Pages, copy the generated HTML to:
